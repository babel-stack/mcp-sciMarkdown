...
<p align="center">
  <strong>Document-to-Markdown converter with LaTeX formula detection, smart image extraction, noise filtering, and semantic analysis with Gemini Embeddings.</strong>
</p>
...
SciMarkdown automatically detects and converts mathematical formulas to LaTeX using multiple layered strategies:
